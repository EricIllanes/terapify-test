...
//RUTA DE PRUEBA PARA EDITAR
// router.get('/edit', async (req, res)=>{
// let hoursEdit= await Hours.updateOne(
//   {
//     "day":'Lunes',
//     "schedule":{"$elemMatch":{"intHOur": "8:00 - 9:00"}}
//     },
//     {
...
router.post("/hours", async (req, res) => {
  ...
  if (!psyFind) {
    ...
    //ej:  ["8:00-9:00", {available:true}]
    // este boolean se modificará para manejar horas disponibles
